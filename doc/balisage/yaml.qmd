...
YAML est un acronyme récursif signifiant : *YAML Ain't Markup Language* :arrow_right: [YAML n’est pas un langage de balisage]{.underline}. Il est donc rangé logiquement dans la section **Balisage** :+1:


C'est un format de sérialisation de données lisible par l'homme, conçu pour être facile à lire et à écrire.
