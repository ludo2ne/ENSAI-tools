---
title: "Mardown"
description: "Pour une mise en forme simple et rapide"
...
Markdown est un langage de balisage léger créé par [John Gruber](https://daringfireball.net/projects/markdown/){target="_blank"} en 2004. Son objectif de simplifier l'écriture de texte destiné au web en permettant aux utilisateurs d'écrire en utilisant un format texte brut facile à lire et à écrire.
...
```{.txt filename="Liste et sous-liste"}
- choux
  - choux fleur
  - choux romanesco
- carotte
...
::: {.callout-note}
Cette page est elle-même écrite en Markdown ! (avec une [surcouche Quarto](https://quarto.org/docs/authoring/markdown-basics.html){target="_blank}) qui ajoute quelques mises en forme supplémentaires (par exemple cet encadré).
