...
- <https://www.sspcloud.fr/>{target="_blank"}
  - <https://datalab.sspcloud.fr/>{target="_blank"} : le Datalab de l'INSEE
  - [La documentation](https://www.sspcloud.fr/catalog?path=SSPCloud%E2%90%A3Documentation){target="_blank"}
  - Mais aussi des tutos, des formations et un agent basé sur des modèles d'IA open source
  - [Healthcheck](https://status.lab.sspcloud.fr){target="_blank"}
...
- [Le SSPCloud : une fabrique créative pour accompagner les expérimentations des statisticiens publics](https://www.insee.fr/fr/information/6035940?sommaire=6035950){target="_blank"}, Courrier des statistiques N7 - 2022

::: {.callout-tip}
Besoin d'assistance :question: Contactez l'équipe du SSPCloud sur [Slack](https://join.slack.com/t/3innovation/shared_invite/zt-1bo6y53oy-Y~zKzR2SRg37pq5oYgiPuA){target="_blank"}
:::
