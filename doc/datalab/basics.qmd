...
- [ ] Générez un [jeton classique](https://github.com/settings/tokens/new){target="_blank"}
  - Renseignez : 
    ...
    - date d'expiration :arrow_right: Custom :arrow_right: `31/07/<next year>`
...
> Ainsi dans chaque service que vous lancerez, sera présente une variable d'environnement nommée `GIT_PERSONAL_ACCESS_TOKEN` contenant la valeur de votre token.
...
- [ ] Intégrez le Token dans l'url https lors du clone
  - Insérer `$GIT_PERSONAL_ACCESS_TOKEN@` juste après *https://*
