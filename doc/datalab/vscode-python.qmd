...
Here is the condensed version in English, using text and lists instead of a table:
...
In short: **Chat** talks about code, **Plan** outlines the strategy, and **Agent** executes the work.
